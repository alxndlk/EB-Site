          ...
          <div className={styles.content}>
            <div className={styles.container}>
              <div className={styles.title_container}>
                <h4>Раздел 1. Освоные правила</h4>
              </div>
              <div className={styles.info}>
                <div className={styles.inputs}>
                  ...
                  <p>
                    ...
                    проектов, ники администрации проекта. В таком случае у
                    пользователя есть 1 час на смену никнейма с помощью сервсиса
                    на сайте или перенос вещей на другой аккаунт для во
                    избежание наказания. <br /> Наказание:
                    <span className={styles.ban}>
                       [Блокировка аккаунта сроком - навсегда]
                    </span>
                  </p>
              ...
              <div className={styles.info}>
                <div className={styles.inputs}>
                  ...
                  <p>
                    ...
                    Наказание:{" "}
                    <span className={styles.ban}>
                      [Блокировка аккаунта сроком от 12 часа до бессрочного, в
