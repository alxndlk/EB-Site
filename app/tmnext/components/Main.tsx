    ...
    <main className={styles.main}>
      ...
      <div className={styles.mods}>
        ...
        <div className={styles.features}>
          ...
          <TableRow
            modName="Ad Astra"
            description="Мод для межпланетных приключений! Стройте космические корабли, исследуйте планеты, добывайте уникальные ресурсы и создавайте базы в далёких мирах. Расширьте свои горизонты и покоряйте космос!"
          />
          <TableRow
            modName="Avaritia"
          ...
          />
          <TableRow
            modName="Draconic Evolution"
            description="Добавляет мощные драконьи технологии, включая артефакты, броню и оружие, которые значительно усиливают ваши возможности. Овладейте силой драконов и станьте неукротимым!"
          />
          <TableRow
            modName="Divine RPG"
