                    ...
                    <div className={styles.stats}>
                        <div className={`${styles.avatar_balance} `}>
                            <div className={styles.text}>
                                ...
                                <div className={styles.paragraph}>
                                    <p>Используйте свой баланс для того что бы покупать предметы и донат-статусы.</p>
                                </div>
                                <div className={`${styles.input_balance}`}>Ваш баланс:<div className={styles.donate_group}>49.00 ₽</div></div>
                            </div>
                            <div className={`${styles.title_balance} justify-between`}>
                                Cредства не подлежат ограничению по сроку использования.
                        ...
                        <div className={`${styles.avatar} `}>
                            <div className={styles.text}>
                                <div className={styles.title_text}>
                                    <h4>Донат-статус</h4>
                                    <div className={styles.donate_group}>игрок</div>
                                </div>
                            </div>
                        ...
                        <div className={`${styles.avatar} `}>
                            <div className={styles.text}>
                                ...
                                <div className={styles.paragraph}>
                                    <p>Это Ваш аватар.<br />
                                    Нажмите на аватар, что бы использовать свое изображение.</p>
                                </div>
                            </div>
                            <div className={styles.title}>Аватар не обязателен, но рекомендуеться его установить.</div>
                            <button className={styles.avatar_button}><CameraIcon size={32 } color='#a1a1a1' absoluteStrokeWidth/></button>
                        </div>
                        ...
                        <div className={`${styles.avatar} `}>
                            <div className={styles.text}>
                                ...
                                <div className={styles.input}>{session?.user?.email}<span className={styles.status}>Основная</span></div>
                            </div>
                        ...
                        <div className={`${styles.avatar} `}>
                            ...
                            <div className={`${styles.title} justify-between`}>Промокод можно использовать только 1 раз.<button className={styles.apply}>Применить</button></div>
                        </div>
                        ...
                        <div className={`${styles.avatar} `}>
                            <div className={styles.text}>
                                ...
                                <div className='flex gap-3'>
                                    <div className={styles.link_container}><FaTelegram />Телеграм</div>
                                    <div className={styles.link_container}><FaDiscord />Дискорд</div>
                                </div>
                            </div>
