            ...
            <div className={styles.status_content}>
                ...
                <div className={styles.donate_table}>
                    ...
                    <div className={styles.top_skills}>
                        <Status text="Кит набор Vip" icons={['check', 'check', 'check', 'check', 'check']} />
                        <Status text="Кит набор Premium" icons={['xmark', 'check', 'check', 'check', 'check']} />
                        <Status text="Кит набор Deluxe" icons={['xmark', 'xmark', 'check', 'check', 'check']} />
                        <Status text="Кит набор ULTRA" icons={['xmark', 'xmark', 'xmark', 'check', 'check']} />
                        <Status text="Кит набор LEGEND" icons={['xmark', 'xmark', 'xmark', 'xmark', 'check']} />
                    </div>
