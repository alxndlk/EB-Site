          ...
          <div className={styles.features_blocks}>
            ...
            >
              ...
              <div className={styles.block_header}>
                ...
                <p>
                  Мы внесли изменения в уникальные моды, которые отвечают за
                  генерацию, обновив их для расширения возможностей и улучшения
                  игрового опыта.
                </p>
              </div>
          ...
          <div className={styles.features_blocks}>
            ...
            >
              <div className={styles.block_header}>
                <h4>Оптимизация</h4>
                <p>
                  Тысячи различных построек и данжей, которые заново создаются
                  когда их зачистили, делая мир ещё более живым. Лута хватит на
                  всех!
                </p>
              </div>
